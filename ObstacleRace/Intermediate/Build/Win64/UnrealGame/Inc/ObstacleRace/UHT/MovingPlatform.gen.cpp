...
#include "ObstacleRace/MovingPlatform.h"
...
// Cross Module References
	...
	OBSTACLERACE_API UClass* Z_Construct_UClass_AMovingPlatform();
	OBSTACLERACE_API UClass* Z_Construct_UClass_AMovingPlatform_NoRegister();
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MovedDistance = { "MovedDistance", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AMovingPlatform, MovedDistance), METADATA_PARAMS(Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MovedDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MovedDistance_MetaData)) };
#if WITH_METADATA
	...
	template<> OBSTACLERACE_API UClass* StaticClass<AMovingPlatform>()
	{
		return AMovingPlatform::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMovingPlatform);
	AMovingPlatform::~AMovingPlatform() {}
	struct Z_CompiledInDeferFile_FID_Unreal_Projects_ObstacleRace_Source_ObstacleRace_MovingPlatform_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_ObstacleRace_Source_ObstacleRace_MovingPlatform_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 3873167687U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_ObstacleRace_Source_ObstacleRace_MovingPlatform_h_2524392168(TEXT("/Script/ObstacleRace"),
		Z_CompiledInDeferFile_FID_Unreal_Projects_ObstacleRace_Source_ObstacleRace_MovingPlatform_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_ObstacleRace_Source_ObstacleRace_MovingPlatform_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
