...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ACryptRaiderGameMode_Statics::ClassParams = {
		...
		0,
		0x008802ACu,
		METADATA_PARAMS(Z_Construct_UClass_ACryptRaiderGameMode_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_ACryptRaiderGameMode_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Unreal_Projects_CryptRaider_Source_CryptRaider_CryptRaiderGameMode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_CryptRaider_Source_CryptRaider_CryptRaiderGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACryptRaiderGameMode, ACryptRaiderGameMode::StaticClass, TEXT("ACryptRaiderGameMode"), &Z_Registration_Info_UClass_ACryptRaiderGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACryptRaiderGameMode), 652336476U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_CryptRaider_Source_CryptRaider_CryptRaiderGameMode_h_3097994270(TEXT("/Script/CryptRaider"),
		Z_CompiledInDeferFile_FID_Unreal_Projects_CryptRaider_Source_CryptRaider_CryptRaiderGameMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_CryptRaider_Source_CryptRaider_CryptRaiderGameMode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
